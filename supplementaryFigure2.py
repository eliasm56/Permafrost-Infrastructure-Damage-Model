# -*- coding: utf-8 -*-
"""
Waterfall decomposition (publication-ready) with FINAL "this study" total pulled from
the FULL uncertainty model *MC draw outputs* (ALL_MC_country_draws.csv), using MEDIANS.

UPDATED to MATCH the decomposition step table:
